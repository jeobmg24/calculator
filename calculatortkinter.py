...
if __name__ == "__main__":
    ...
    gui.geometry("300x230")
    equation = StringVar()
    expression_field = Entry(gui, textvariable=equation)
    expression_field.grid(columnspan=4, ipadx=70)
    button1 = Button(gui, text=' 1 ', fg='black', bg='purple', 
    ...
    button3 = Button(gui, text=' 3 ', fg='black', bg='purple', 
    ...
    button5 = Button(gui, text=' 5 ', fg='black', bg='purple', 
    ...
    button7 = Button(gui, text=' 7 ', fg='black', bg='purple', 
    ...
    button9 = Button(gui, text=' 9 ', fg='black', bg='purple', 
